    ...
    function e() {
      _classCallCheck(this, e),
        ...
        document.addEventListener(
          'contextmenu',
          this._eventOpenMenu.bind(this)
        );
      var n = document.getElementsByTagName('script'),
        t =
          n[n.length - 1].src.split('?')[0].split('/').slice(0, -1).join('/') +
          '/',
        s = document.createElement('link');
      (s.href = t + 'ctxmenu.min.css'),
        (s.type = 'text/css'),
        (s.rel = 'stylesheet'),
      ...
      _createClass(e, [
          ...
          value: function (e) {
            ...
            if ((this.closeCurrentlyOpenedMenu(), null != n)) {
              ...
              0 != t
                ? 1 != t &&
                  ((t._elementClicked = s),
                  t.openMenu(e.pageX, e.pageY),
                  (this._currentMenuVisible = t),
                  document.addEventListener(
                    'click',
                    CtxCloseCurrentlyOpenedMenus
                  ),
                  ...
                  e.preventDefault(),
                  null != t._openEventListener && t._openEventListener())
                : e.preventDefault();
            }
          },
        },
        ...
        },
        {
          ...
          value: function (e) {
            ...
            if (this._ctxMenus.has('#' + e.id))
              return this._ctxMenus.get('#' + e.id);
            if (null != e.className)
              for (var n = e.className.split(' '), t = 0; t < n.length; t++)
                if (this._ctxMenus.has('.' + n[t]))
                  return this._ctxMenus.get('.' + n[t]);
            return this._ctxMenus.has(e.nodeName)
              ? this._ctxMenus.get(e.nodeName)
              : null;
          },
        },
        {
  ...
  CtxMenuClass = (function () {
    function e() {
      _classCallCheck(this, e),
        ...
        this.closeMenu(),
        (this._elementClicked = void 0),
        (this._openEventListener = void 0),
        (this._closeEventListener = void 0),
        (this._clickEventListener = void 0);
    }
    return (
      _createClass(e, [
        {
          ...
          value: function (e, n) {
            ...
            return (
              ...
              r && this.menuContainer.classList.add(ECtxMenuNames.hasIcon),
              this.menuContainer.insertBefore(
                i,
                this.menuContainer.childNodes[s]
              ),
              i
            );
          },
        },
        {
          ...
          value: function () {
            ...
            return (
              (n.className = ECtxMenuNames.separator),
              this.menuContainer.insertBefore(
                n,
                this.menuContainer.childNodes[e]
              ),
              n
            );
          },
        ...
        },
        {
          ...
          value: function (e, n) {
            ...
            e + this.menuContainer.offsetWidth > t &&
              (e = t - this.menuContainer.offsetWidth - 1),
              n + this.menuContainer.offsetHeight > s &&
                (n = s - this.menuContainer.offsetHeight - 1),
              (this.menuContainer.style.left = e + 'px'),
              (this.menuContainer.style.top = n + 'px');
          },
        },
        {
          key: 'closeMenu',
          value: function () {
            (this.menuContainer.style.left = '0px'),
              ...
              null != this._closeEventListener && this._closeEventListener();
          },
        },
        {
          key: '_callItem',
          value: function (e) {
            this.closeMenu(),
              setTimeout(
                function () {
                  e(this._elementClicked),
                    null != this._clickEventListener &&
...
function CtxMenu(e) {
  return (
    null == e && (e = document),
    null != ctxMenuManager.getMenuFromElement(e)
      ? ctxMenuManager.getMenuFromElement(e)
      : ctxMenuManager.createNewMenu(e)
  );
}
